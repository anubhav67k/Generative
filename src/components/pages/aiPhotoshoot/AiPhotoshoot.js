    ...
    <>
      ...
      <div className="Aiphotoshoot">
          ...
          <div className="left-Section">
            <div className="left-Container">
              <div className="heading2">
                Create unique product images in your brand style
              </div>
              <p>
                Turn generic product photos into catchy visuals in seconds with
                AI
              </p>
              <div className="gen-btn">
                <Link to="/ImageGeneration">
                  <button className="btn">Generate Product Images</button>
                </Link>
              </div>
            </div>
          </div>
        ...
        <div className="underhero">
          <div className="container2">
            <div className="heading1">
              From simple product shots
              <span> to attractive styles</span>
              <p>
                Engage your clients by transforming one simple product image
                into endless beautiful photoshoots that suit your brand
              </p>
            </div>
          </div>
        ...
        <div className="functions">
          <div className="container2">
            <div className="heading1">
              Easy to navigate, generate and scale
              <p>
